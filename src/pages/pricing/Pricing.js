...
const PricingCard = ({
  ...
  return (
    <>
      <div className="max-w-[350px] px-4 md:w-1/2 lg:w-1/3">
        <div className="relative z-10 px-8 py-10 mb-10 overflow-hidden bg-white border rounded-xl border-primary border-opacity-20 shadow-pricing sm:p-10 lg:py-10 lg:px-6 xl:p-10">
          ...
          <p className="mb-8 border-b border-[#F2F2F2] pb-8 text-left text-body-color">
            {description}
          </p>
          <ul className="mb-7 ">
...
const List = ({ children }) => {
  return (
    <>
      <p className="mb-1 text-left leading-loose text-body-color">{children}</p>
    </>
  );
};
